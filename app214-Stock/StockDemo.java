...
public class StockDemo
{
    ...
    public StockDemo(StockList stock)
    {
        ...
        stock.add(new Product(101, "WHITE WINE"));
        stock.add(new Product(102, "RED WINE"));
        stock.add(new Product(103, "GRAPES WINE"));
        stock.add(new Product(104, "ROSE WINE"));
        stock.add(new Product(105, "ORANGE WINE"));
        stock.add(new Product(106, "APPLE WINE"));
        stock.add(new Product(107, "PEARS WINE"));
        stock.add(new Product(108, "SPARKLING WINE"));
        stock.add(new Product(109, "DESSERT WINE"));
        stock.add(new Product(110, "SPILT WINE"));
        runDemo();
    }
